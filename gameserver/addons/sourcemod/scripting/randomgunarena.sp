...
public void OnPluginStart()
{
	...
	cvar_RemoveType = CreateConVar("rga_removetype", "2", "0 = Do not remove any weapons from pool. 1 = rga_removepreviousweapons. 2 = rga_removepreviousgroups. You cannot do both", _, true, 0.0, true, 2.0);
